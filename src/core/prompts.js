...
5. ГЕОГРАФИЯ:
   - Если юзер упоминает свой город/страну ("У нас в Москве дождь", "Я из Киева", "По времени Екб"), запиши это в поле "location".
   - Если локация уже есть и она не изменилась — не трогай.
